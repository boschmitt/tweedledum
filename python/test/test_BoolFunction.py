...
class TestBoolFunctionFullSimulation(unittest.TestCase):
        def test_identity(self):
            ...
            self.assertEqual(len(function._truth_table), 1)
            self.assertEqual(str(function._truth_table[0]), '10')
        ...
        def test_identity_2bit(self):
            function = BoolFunction(examples.identity_2bit)
            function.simulate_all()
            self.assertEqual(len(function._truth_table), 2)
            self.assertEqual(str(function._truth_table[0]), '1010')
            self.assertEqual(str(function._truth_table[1]), '1100')
        ...
        def test_not(self):
            ...
            function.simulate_all()
            self.assertEqual(len(function._truth_table), 1)
            self.assertEqual(str(function._truth_table[0]), '01')
        ...
        def test_not_2bit(self):
            ...
            function.simulate_all()
            self.assertEqual(len(function._truth_table), 2)
            self.assertEqual(str(function._truth_table[0]), '0101')
            self.assertEqual(str(function._truth_table[1]), '0011')
        ...
        def test_and(self):
            ...
            function.simulate_all()
            self.assertEqual(len(function._truth_table), 1)
            self.assertEqual(str(function._truth_table[0]), '1000')
        ...
        def test_and_2bit(self):
            ...
            self.assertEqual(str(function._truth_table[0]), str(output0))
            self.assertEqual(str(function._truth_table[1]), str(output1))
        ...
        def test_or(self):
            ...
            function.simulate_all()
            self.assertEqual(len(function._truth_table), 1)
            self.assertEqual(str(function._truth_table[0]), '1110')
        ...
        def test_xor_str(self):
            ...
            function.simulate_all()
            self.assertEqual(len(function._truth_table), 1)
            self.assertEqual(str(function._truth_table[0]), '0110')
