...
void linear_synth_binary(Network& network, std::vector<uint32_t> const& qubits, parity_terms parities)
{
...
template<class Network>
void linear_synth_gray(Network& network, std::vector<uint32_t> const& qubits, parity_terms parities)
{
	const auto num_qubits = qubits.size();
 ...
 */
template<class Network>
void linear_synth(Network& network, std::vector<uint32_t> const& qubits,
 ...
 */
template<class Network>
Network linear_synth(uint32_t num_qubits, parity_terms const& parities,
