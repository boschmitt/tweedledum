...
public:
	xag_synth(QuantumNetwork& q_network, LogicNetwork const& c_network, hrs_info* info,
...
/*! \brief */
template<class QuantumNetwork>
void xag_synth(QuantumNetwork& q_network, mockturtle::xag_network const& c_network,
               hrs_info* info = nullptr, xag_synth_params const& params = {})
{
	detail::xag_synth synthesizer(q_network, c_network, info, params);
	synthesizer.synthesize();
}

/*! \brief */
template<class QuantumNetwork>
QuantumNetwork xag_synth(mockturtle::xag_network const& c_network, hrs_info* info = nullptr,
                         xag_synth_params const& params = {})
{
	QuantumNetwork q_network;
	xag_synth(q_network, c_network, info, params);
	return q_network;
}
